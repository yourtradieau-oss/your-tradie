...
export default function App() {
  ...
  // ---- DEV MODE — two-sided split screen ----
  if (isDevMode) {
    return (
      <div style={{
        minHeight: "100vh",
        ...
        <Logo />
        <div style={{ fontSize: 11, color: "#F4822A", letterSpacing: 2, textTransform: "uppercase", marginBottom: 32, marginTop: 8 }}>
          Dev Mode
        </div>

        {view === "home" && (
          <div style={{ width: "100%", maxWidth: 420 }}>
            <div style={{ fontSize: 22, fontWeight: 800, color: "#fff", textAlign: "center", marginBottom: 8 }}>
              Who are you?
            </div>
            <div style={{ fontSize: 15, color: "rgba(255,255,255,0.4)", textAlign: "center", marginBottom: 32 }}>
              Select the option that best describes you.
            </div>
            <button
              onClick={() => setView("tradie")}
              style={{
        ...
        {view === "tradie" && (
          <div style={{
            ...
            <div style={{ fontSize: 20, fontWeight: 800, color: "#fff", marginBottom: 12 }}>Tradie Dashboard</div>
            <div style={{ fontSize: 14, color: "rgba(255,255,255,0.4)", marginBottom: 24 }}>Coming soon — tradie profile, jobs, dashboard.</div>
            <button onClick={() => setView("home")} style={{ background: "none", border: "none", color: "rgba(255,255,255,0.3)", fontSize: 13, cursor: "pointer" }}>← Back</button>
          </div>
        )}
        ...
        {view === "customer" && (
          <div style={{
            ...
            <div style={{ fontSize: 14, color: "rgba(255,255,255,0.4)", marginBottom: 24 }}>Coming soon — search, browse tradies, post a job.</div>
            <button onClick={() => setView("home")} style={{ background: "none", border: "none", color: "rgba(255,255,255,0.3)", fontSize: 13, cursor: "pointer" }}>← Back</button>
          </div>
        )}
